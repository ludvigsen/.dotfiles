...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(prettier-js solidity-mode)
 ...
 ((eq window-system 'w32)
  ...
  (eval-after-load 'grep
    '(progn
       ...
       (add-to-list 'grep-find-ignored-directories "flow-temp")
       (add-to-list 'grep-find-ignored-directories "target")
       (add-to-list 'grep-find-ignored-directories "node_modules")
       (add-to-list 'grep-find-ignored-directories "build")
       (add-to-list 'grep-find-ignored-directories "out")
       (add-to-list 'grep-find-ignored-directories "deploy")
